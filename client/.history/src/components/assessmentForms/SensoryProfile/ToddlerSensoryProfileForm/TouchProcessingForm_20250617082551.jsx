https://tronic.lk/product/mt3608-dc-dc-boost-converter-booster-power-module-micro
...
function ToddlerTouchProcessingForm() {
  ...
  const handleFormSubmit = ({ responses, comments, totalScore }) => {
    console.log("Touch Processing Form Responses:", responses);
    console.log("Touch Raw Score:", totalScore);
    console.log("Touch Processing Comments:", comments);
  };
