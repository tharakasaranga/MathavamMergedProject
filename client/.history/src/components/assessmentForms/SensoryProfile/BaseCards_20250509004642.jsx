...
function BaseCards({ sensoryName, isExpanded, onToggle, formType }) {
  // Determine which form component to render based on formType and sensoryName
  const renderForm = () => {
    if (formType === "child") {
      // Child Sensory Profile 2 Forms (3:0 to 14:11 years)
      switch (sensoryName) {
        case "Auditory Processing":
          return <AuditoryProcessingForm />;
        case "Visual Processing":
          return <VisualProcessingForm />;
        case "Touch Processing":
          return <TouchProcessingForm />;
        case "Movement Processing":
          return <MovementProcessingForm />;
        case "Body Position Processing":
          return <BodyPositionProcessingForm />;
        case "Oral Sensory Processing":
          return <OralSensoryProcessingForm />;
        case "Conduct Associated with Sensory Processing":
          return <ConductSensoryProcessingForm />;
        case "Social Emotional Responses Associated with Sensory Processing":
          return <SocialEmotionalSensoryProcessingForm />;
        case "Attentional Responses Associated with Sensory Processing":
          return <AttentionalSensoryProcessingForm />;
        default:
      ...
      switch (sensoryName) {
        case "General Processing":
          return <ToddlerGeneralProcessingForm />;
        case "Auditory Processing":
          return <ToddlerAuditoryProcessingForm />;
        case "Visual Processing":
          return <ToddlerVisualProcessingForm />;
        case "Touch Processing":
          return <ToddlerTouchProcessingForm />;
        case "Movement Processing":
          return <ToddlerMovementProcessingForm />;
        case "Oral Sensory Processing":
          return <ToddlerOralSensoryProcessingForm />;
        case "Behavioral Associated with Sensory Processing":
          return <ToddlerBehavioralProcessingForm />;
        default:
          return <div>Form not found</div>;
      }
    }
