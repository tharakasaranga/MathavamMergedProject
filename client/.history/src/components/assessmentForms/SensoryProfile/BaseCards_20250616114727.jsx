...
function BaseCards({ sensoryName, isExpanded, onToggle, formType, patientId, examinerId}) {
 
  console.log(
    `Rendering BaseCards for '${sensoryName}'. patientId:`,
    patientId,
    "examinerId:",
    examinerId
  );
    ...
    if (formType === "child") {
      ...
      switch (sensoryName) {
        case "Auditory Processing":
          return <AuditoryProcessingForm patientId={patientId} examinerId={examinerId} />;
        case "Visual Processing":
          return <VisualProcessingForm patientId={patientId} examinerId={examinerId}/>;
        case "Touch Processing":
          return <TouchProcessingForm patientId={patientId} examinerId={examinerId}/>;
        case "Movement Processing":
          return <MovementProcessingForm patientId={patientId} examinerId={examinerId}/>;
        case "Body Position Processing":
          return <BodyPositionProcessingForm patientId={patientId} examinerId={examinerId} />;
        case "Oral Sensory Processing":
          return <OralSensoryProcessingForm patientId={patientId} examinerId={examinerId}/>;
        case "Conduct Associated with Sensory Processing":
          return <ConductSensoryProcessingForm patientId={patientId} examinerId={examinerId} />;
        case "Social Emotional Responses Associated with Sensory Processing":
          return <SocialEmotionalSensoryProcessingForm patientId={patientId} examinerId={examinerId} />;
        case "Attentional Responses Associated with Sensory Processing":
          return <AttentionalSensoryProcessingForm patientId={patientId} examinerId={examinerId}/>;
        default:
      ...
      switch (sensoryName) {
        case "General Processing":
          return <ToddlerGeneralProcessingForm patientId={patientId} examinerId={examinerId}/>;
        case "Auditory Processing":
          return <ToddlerAuditoryProcessingForm patientId={patientId} examinerId={examinerId}/>;
        case "Visual Processing":
          return <ToddlerVisualProcessingForm patientId={patientId} examinerId={examinerId}/>;
        case "Touch Processing":
          return <ToddlerTouchProcessingForm patientId={patientId} examinerId={examinerId}/>;
        case "Movement Processing":
          return <ToddlerMovementProcessingForm patientId={patientId} examinerId={examinerId}/>;
        case "Oral Sensory Processing":
          return <ToddlerOralSensoryProcessingForm patientId={patientId} examinerId={examinerId}/>;
        case "Behavioral Associated with Sensory Processing":
          return <ToddlerBehavioralProcessingForm patientId={patientId} examinerId={examinerId}/>;
        default:
          return <div>Form not found</div>;
      }
    }
